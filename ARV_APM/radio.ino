...
{
    channel_steer     = RC_Channel::rc_channel(CH_STEER);
    channel_throttle  = RC_Channel::rc_channel(CH_THROTTLE);
    channel_throttle2 = RC_Channel::rc_channel(CH_THROTTLE2);

	// set rc channel ranges
	channel_steer->set_angle(SERVO_MAX);
	channel_throttle->set_angle(100);
	channel_throttle2->set_angle(100);
}
...
static void init_rc_in()
{
	...
	channel_throttle2->set_dead_zone(6);
...
static void read_radio()
{
	...
	channel_throttle2->servo_out = channel_throttle2->control_in;
